...
const IndexCommand = require('../../../../src/commands/event/provider')
...
describe('instance methods', () => {
  ...
  describe('run', () => {
    ...
    test('returns help file for event provider command', () => {
      const spy = jest.spyOn(Help.prototype, 'showHelp').mockReturnValue(true)
      return command.run().then(() => {
        expect(spy).toHaveBeenCalledWith(['event:provider', '--help'])
      })
    })
  })
})
